...
Elm.Main.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var view = function (model) {    return A2($Html.div,_U.list([]),_U.list([$Html.text(model.message)]));};
   var model = {message: "Hello"};
   var main = view(model);
   var Model = function (a) {    return {message: a};};
   return _elm.Main.values = {_op: _op,Model: Model,model: model,view: view,main: main};
};
